...
/**
 * hsh - main shell loop
 * @info: the parameter & return info struct statement
 * @av: the argument vector for main()
 ...
 * 1 if builtin is found but not excuted successful,
 * 2 if the  builtin signifies or signals exit()
 */
